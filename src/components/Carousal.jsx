...
const Carousal = () => {
  const images = [dummyImage, dummyImage2, dummyImage3, dummyImage4, dummyImage5, dummyImage6];
    ...
    <>
      <div className="relative w-full h-[90vh] sm:h-[90vh] md:h-[70vh] lg:h-[80vh] overflow-hidden">
          ...
          {images.map((img, index) => (
            ...
            >
            <div className="bg-opacity-30 backdrop-blur-sm border border-white/30 lg:ml-6 text-white p-3 sm:p-2 md:p-3 lg:p-4 rounded-lg flex flex-col justify-between h-auto sm:h-1/2 w-full sm:w-3/4 md:w-2/3 lg:w-1/2">
              ...
              <div className="text-2xl sm:text-4xl lg:text-3xl font-bold">TITLE</div>
              <div className="text-md sm:text-xl lg:text-sm font-extralight">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Eius delectus magni ducimus soluta. Corporis saepe ab ipsam nam aspernatur, molestias ratione voluptatem quos placeat neque iusto, nobis ad. Quae, illum!
              </div>
