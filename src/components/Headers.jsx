      ...
      {isMenuOpen && (
        <nav className="md:hidden bg-black flex flex-col space-y-2 pt-6 fixed inset-0 z-40 h-screen top-0 overflow:hidden">
          <div className="pl-8 flex-row space-between text-xl">
            ...
            <Link to="/movies" className="block py-2 hover:text-gray-200">
              Movies
            </Link>
            <Link to="/series" className="block py-2 hover:text-gray-200">
              Series
            </Link>
            <Link to="/kids" className="block py-2 hover:text-gray-200">
              Kids
            </Link>
            <Link
              to="/watchlist"
